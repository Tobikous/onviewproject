	...
	<main class="px-5 py-2 mx-auto xl:px-20 tails-selected-element">
		...
		<div class="flex flex-wrap mt-14 overflow-hidden px-5 md:px-0">
			...
			<div class="w-full overflow-hidden md:w-3/4 md:pr-5 md:pl-9">
				...
				@if (isset($tagName))
				<div class="p-5 text-2xl font-bold bg-orange-100 mt-5 md:mt-0">「{{$tagName}}」タグのレビュー一覧</div>
				@endif

				@if (isset($keyword))
				<div class="p-5 text-2xl font-bold bg-orange-100 mt-5 md:mt-0">「{{$keyword}}」での検索結果</div>
				@endif
