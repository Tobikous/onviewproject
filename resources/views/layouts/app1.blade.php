		...
		<div class="flex items-center justify-between h-20 px-8 mx-auto max-w-7xl">
			...
			<nav class="items-center justify-center hidden space-x-8 text-white md:flex">
				...
				<a href="{{ route('register') }}"
					class="relative inline-flex items-center justify-start px-4 py-3 overflow-hidden font-medium transition-all bg-orange-400 rounded-xl group">
					<span
						class="absolute top-0 right-0 inline-block w-4 h-4 transition-all duration-500 ease-in-out bg-orange-600 rounded group-hover:-mr-4 group-hover:-mt-4">
						<span
							class="absolute top-0 right-0 w-5 h-5 rotate-45 translate-x-1/2 -translate-y-1/2 bg-white"></span>
					</span>
					<span
						class="absolute bottom-0 left-0 w-full h-full transition-all duration-500 ease-in-out delay-200 -translate-x-full translate-y-full bg-orange-500 rounded-2xl group-hover:mb-12 group-hover:translate-x-0"></span>
					<span
